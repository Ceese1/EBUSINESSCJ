...
class CrudUsuario{
    ...
    public function insertar($usuario){
        $db=DB::conectar();
        $insert=$db->prepare('INSERT INTO USUARIOS VALUES(NULL, :nombre_completo, :correo, :usuario, :clave)');
        $insert->bindValue('nombre_completo', $usuario->getNombre());
    ...
    public function obtenerUsuario($usuario, $clave){
        ...
        if (password_verify($clave, $registro['clave'])){
            ...
            $usuario->setNombre($registro['nombre_completo']);
